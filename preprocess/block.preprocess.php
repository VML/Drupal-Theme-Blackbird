 ...
 * Index:
 *
 * @see blackbird_preprocess_block()
 */
 ...
 */
function blackbird_preprocess_block(array &$variables) {
  /*
   * Pass id into menu attributes for better hook-suggestions.
   * @see blackbird_theme_suggestions_menu_alter();
   */
 ...
 */
function blackbird_preprocess_block__page_title_block(&$variables) {
