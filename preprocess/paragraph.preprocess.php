 ...
 * Index:
 *
 * @see blackbird_preprocess_paragraph()
 * @see blackbird_preprocess_paragraph__accordion__full()
 * @see blackbird_preprocess_paragraph__accordion_item__full()
 * @see blackbird_preprocess_paragraph__content__full()
 * @see blackbird_preprocess_paragraph__hero__full()
 * @see blackbird_preprocess_paragraph__hero_slide__full()
 * @see blackbird_preprocess_paragraph__embed_iframe__full()
 * @see blackbird_preprocess_paragraph__media__full()
 * @see blackbird_preprocess_paragraph__section__full()
 * @see blackbird_preprocess_paragraph__slider__full()
 * @see blackbird_preprocess_paragraph__tabs__full()
 * @see blackbird_preprocess_paragraph__tabs_tab__full()
 */
 ...
 */
function blackbird_preprocess_paragraph(array &$variables) {
 ...
 */
function blackbird_preprocess_paragraph__content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function blackbird_preprocess_paragraph__featured_content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
  ...
  switch ($layout) {
    case 'featured_content_layout__grid':
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-content--layout-grid';
    ...
    case 'featured_content_layout__masonry':
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-content--layout-masonry';
      $field_settings['type'] = 'entity_reference_entity_view';
    ...
    default:
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-content--layout-list';
 ...
 */
function blackbird_preprocess_paragraph__featured_media__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
  ...
  switch ($layout) {
    case 'featured_media_layout__grid':
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-media--layout-grid';
      $field_settings['type'] = 'entity_reference_entity_view';
      $field_settings['settings']['view_mode'] = 'teaser';
      $field_settings['label'] = 'hidden';
      break;
    ...
    case 'featured_media_layout__masonry':
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-media--layout-masonry';
      $field_settings['type'] = 'entity_reference_entity_view';
      $field_settings['settings']['view_mode'] = 'masonry';
      $field_settings['label'] = 'hidden';
      break;
    ...
    case 'featured_media_layout__slider':
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-media--layout-slider';
      $field_settings['type'] = 'entity_reference_entity_view';
    ...
    default:
      $variables['#attached']['library'][] = 'blackbird/paragraph--full--featured-media--layout-full';
      $field_settings['type'] = 'entity_reference_entity_view';
      $field_settings['settings']['view_mode'] = 'embed';
      $field_settings['label'] = 'hidden';
      break;
 ...
 */
function blackbird_preprocess_paragraph__hero__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function blackbird_preprocess_paragraph__tabs__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function blackbird_preprocess_paragraph__tabs_tab__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
